...
public class Teste {
	...
	public static void main(String[] args) {
		...
		Funcionario funcionario = new Funcionario("Carlos Silva", "111.222.333-44", LocalDate.of(1985, 6, 15), 8500.00,
				dependentes);
		funcionarios.add(funcionario);

		Dependente dependente1 = new Dependente("João", "123.456.789-01", LocalDate.of(2015, 5, 10), Parentesco.FILHO,
				funcionario);

		Dependente dependente2 = new Dependente("Maria", "987.654.321-09", LocalDate.of(2012, 3, 22),
				Parentesco.SOBRINHO, funcionario);
		...
		funcionario.setDependente(dependentes);
